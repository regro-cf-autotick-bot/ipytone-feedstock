...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipytone-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11870&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipytone-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipytone` can be installed with:

```
conda install ipytone
```

It is possible to list all of the versions of `ipytone` available on your platform with:
